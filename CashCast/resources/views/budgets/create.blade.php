...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Create Budget Plan</h1>
        ...
        <form method="POST" action="{{ route('budgets.store') }}">
            ...
            <div class="mt-6">
                ...
                <textarea id="description" 
                          ...
                          placeholder="Budget description (optional)">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
...
<script>
// Auto-set end date based on period and start date
